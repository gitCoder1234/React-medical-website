        ...
        <div className={styles.jobs6content5}>
          <ul>
            ...
            <li>
              ...
              We are seeking an experienced Medical Billing Specialist to join
              our administrative team. Responsibilities include verifying
              insurance coverage, submitting claims, processing payments, and
            ...
            <li>
              ...
              <ul>
                ...
                <ul>
                  <li> Proficiency in medical billing software (e.g., EPIC, Medisoft)</li>
                </ul>
                <ul>
